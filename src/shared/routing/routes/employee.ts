...
import {
    ...
    PUBLICATIONS_STATISTICS,
    FRACTION_SHARE_STATISTICS,
...
export const employeeRoutes: (params: { allowancesRoles: Role[] }) => IRoutes = ({ allowancesRoles }) => ({
    ...
    'publications-statistics': {
        id: 'publications-statistics',
        title: 'Статистика публикаций по подразделениям',
        icon: FiFileText,
        path: PUBLICATIONS_STATISTICS,
        color: 'purple',
        isTemplate: false,
        group: 'SCIENCE',
        pageSize: 'large',
    ...
    'fraction-share-statistics': {
        id: 'fraction-share-statistics',
        title: 'Статистика Fraction Share',
        icon: FiFileText,
        path: FRACTION_SHARE_STATISTICS,
        color: 'lightBlue',
        isTemplate: false,
        group: 'SCIENCE',
        pageSize: 'large',
